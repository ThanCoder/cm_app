...
class WebsiteServices {
  ...
  Future<List<Website>> getList() async {
    ...
    list.add(
      Website(
        title: 'MM SubMovie Kesug',
        url:
            'https://node-browser.vercel.app/?url=https://mmsubmovie.kesug.com',
        hostUrl:
            'https://node-browser.vercel.app/?url=https://mmsubmovie.kesug.com',
        moviePage: WebsitePage(
          title: 'Movie',
          moreUrl:
              'https://node-browser.vercel.app/?url=https://mmsubmovie.kesug.com/movies',
          selectorAll: '.movies',
        ...
        tvShowPage: WebsitePage(
          title: 'TV Shows',
          moreUrl:
              'https://node-browser.vercel.app/?url=https://mmsubmovie.kesug.com/tvshows',
          selectorAll: '.tvshows',
          titleQuery: Query(attribute: 'text', selector: '.data a'),
          urlQuery: Query(attribute: 'href', selector: '.data a'),
          coverUrlQuery: Query(attribute: 'src', selector: '.poster img'),
